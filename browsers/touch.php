...
<head><meta name="viewport" content="width=320"/><link href="'.BASE_URF.'favicon.png" rel="shortcut icon" type="image/png" /><title>'.$title.'-'.$page.'-'.DABR_TITLE.'</title><base href="',BASE_URL,'" />
'.theme('css').'
</head>
